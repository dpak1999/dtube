            ...
            <ul role="list" className="flex flex-1 flex-col gap-y-7">
              ...
              <li className="mt-auto">
                ...
                <Link
                  ...
                  className="hover:text-primary-600 group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-700 hover:bg-gray-50"
                >
                  <HelpCircle className="group-hover:stroke-primary-600 h-5 w-5 shrink-0 stroke-gray-500" />
                  <p className={classNames(closeSidebar ? "hidden" : "")}>
                    Help
                  </p>
                </Link>
              ...
              >
                ...
                <div className=" flex grow  flex-col gap-y-5 overflow-y-auto border-r  border-gray-200 bg-white  px-6 pb-4">
                  <nav className="flex flex-1 flex-col pt-4">
                    <ul role="list" className="flex flex-1 flex-col pt-4">
                      <Logo className="w-24" />
                      ...
                      {sessionData ? (
                        <div className="my-2 flex flex-row bg-blue-300 p-2">
